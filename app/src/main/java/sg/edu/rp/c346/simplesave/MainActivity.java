...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onPause() {
        ...
        prefEdit.putString("greeting", "Hello1");
    ...
    protected void onResume() {
        ...
        //Step 2a: Obtain an instance of this SharedPreferences
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
        //Step2b: Retrieve the saved data with the key "greeting" from the SharedPreference object
